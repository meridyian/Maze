...
// will be only used by mazeconstructor
public class MazeMeshGenerator 
{
    ...
    private void AddQuad(Matrix4x4 matrix, ref List<Vector3> newVertices, ref List<Vector2>newUVs, ref List<int> newTriangles)
    {
        ...
        // first parameter was a matrix, multiply point3x4 is storing position/rotation/scale in a matrix and then applies to vertices
